...
public class SignupOne extends JFrame implements ActionListener{
    ...
    JButton next;                                                               
    JRadioButton male,female,other,otherm,married,unmarried;                    
    ...
    SignupOne(){                                                                
        ...
        JLabel personDetails = new JLabel("Page 1: Peronal Details");
        ...
        other.setBounds(600,290,150,30);
        ...
        otherm.setBounds(600,390,100,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if (name.equals("")){
                ...
                setVisible(false);      // ye current frame ko bnd kr dega
                new SignUpTwo(formno).setVisible(true);       // ye dusri class ke frame ko dikha dega
            }
